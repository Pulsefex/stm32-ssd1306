/********
 *
 * This was gotten from https://github.com/afiskon/stm32-ssd1306
 * We opted to use these pre-existing fonts to avoid unnecessary duplication
 * and focus on optimizing the SSD1306 driver implementation.
 *
 ****/
